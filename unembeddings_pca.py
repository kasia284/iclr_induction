...
to final_activations_pca_with_unembeddings.py's overlay version.)

W_U is read directly from the cached safetensors shard (activation_unembedding_dot_product.py's load_unembedding_matrix). Runs for every
