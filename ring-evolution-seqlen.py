...
with context length. Ring analog of morphology-grid-evolution-layers-vs-
seqlen.py, minus the layer dimension.
...
Usage:
    python ring-evolution-seqlen.py                   # all RING_SWEEP_KEYS
    python ring-evolution-seqlen.py <key> [<key> ...]  # only these keys
"""
