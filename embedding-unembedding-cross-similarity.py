...
Unlike real-embeddings-gram-matrix.py / real-embeddings-gram-matrix-
unembed.py (which each compare a vector set against ITSELF, giving
...
real-embeddings-nearest-neighbors.py's load_embedding_only_model and
activation-unembedding-dot-product.py's load_unembedding_matrix). Runs for
