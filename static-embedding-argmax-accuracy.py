...
the row-argmax check already drawn in activation-unembedding-dot-
product.py's heatmaps, just turned into a single scalar per word list
...
activation-unembedding-dot-product.py's load_unembedding_matrix), and
