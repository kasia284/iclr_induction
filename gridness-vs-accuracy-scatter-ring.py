...
permutations). Analogous to gridness-vs-accuracy-scatter-interactive-
thumbnails.py for the Grid task -- hover or click a point to reveal its
...
reused from gridness-vs-accuracy-scatter.py, which is topology-agnostic)
