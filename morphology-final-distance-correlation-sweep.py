"""Like morphology-final-dirichlet-energy-sweep.py, but colors each
...
all-pairs energy ratio). Companion to morphology-distance-correlation-
sweep.py, which uses the STATIC W_E distance correlation instead.
