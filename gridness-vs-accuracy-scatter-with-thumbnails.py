"""Same scatter as gridness-vs-accuracy-scatter.py (final-layer distance
...
families / make_grid from gridness-vs-accuracy-scatter.py (imported via
importlib since its filename isn't a valid module identifier).
"""
