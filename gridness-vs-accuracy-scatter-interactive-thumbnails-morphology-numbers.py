"""Same interactive scatter as gridness-vs-accuracy-scatter-interactive-
thumbnails.py (final-layer distance correlation vs. real accuracy, hover
...
Reuses everything from gridness-vs-accuracy-scatter-interactive-
thumbnails.py (imported via importlib since its filename isn't a valid
module identifier) -- only the key list and output filename differ. Pure
...
interactive_mod = _load_module(
    ...
    "gridness-vs-accuracy-scatter-interactive-thumbnails.py",
)
