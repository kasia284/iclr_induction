...
gridness_vs_accuracy_scatter.py's compute_final_dc), just with W_E instead
of final-layer activations. Reuses real_embeddings_nearest_neighbors.py's
...
groups gridness_vs_accuracy_scatter.py's assign_families operates on:
...
nn_mod = _load_module("real_embeddings_nearest_neighbors", "real_embeddings_nearest_neighbors.py")  # load_embedding_only_model
dot_product_mod = _load_module("activation_unembedding_dot_product", "activation_unembedding_dot_product.py")  # to_single_token
