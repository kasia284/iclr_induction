"""Like activation_unembedding_dot_product.py, but instead of each token's
...
# Reuse plot_dot_product_heatmap from activation_unembedding_dot_product.py,
# loaded via importlib rather than a plain import, same convention used
# elsewhere in this repo, e.g. run_capital_letters_layer_pca.py /
# 03_neighbor_mixing_grid_likeness_check.py.
